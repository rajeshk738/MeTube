...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php?page=Home"></i> <img src="files/images/metube.png" title = 'logo' alt = "MeTube" width = 75px height = 30px></a>
        ...
        <ul style="list-style-type:none;">
            ...
            if ($loggedInUserName != "") {
                ...
                <li class='nav-item'>
                    ...
                    <li class='nav-item'>
                      <a href='playlist.php?id='>My Playlist</a>
                    </li>
                    <li class='nav-item'>
                      <a href='favorites.php'>My Favourites</a>
                    </li>
                        <li class='nav-item'>
            ...
            ?>
            <li class='nav-item'>
                <a href='wordCloud.php'>Word Cloud Search</a>
            </li>
        </ul>
    </div>
